defmodule Braise.LinkAction do
  ...
  # TODO: The dereferencer should do this lookup for us - but better by using the definitions
  defp parse_resource_url(resource, href) do
    ...
    regex = ~r/.*#{plural_resource}\/?(?<id>\w*)\/?(?<custom_action>.*)/
    Regex.named_captures(regex, href)
  end
